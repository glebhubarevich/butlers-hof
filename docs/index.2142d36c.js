...
require('./slider.js');
require('./map.js');
var _jquery360MinJs = require('./jquery-3.6.0.min.js');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _jquery360MinJsDefault = _parcelHelpers.interopDefault(_jquery360MinJs);
window.$ = window.jQuery = _jquery360MinJsDefault.default;
_jquery360MinJsDefault.default(document).ready(function () {
  // Closing/Opening modal
  _jquery360MinJsDefault.default('.modal__close-btn, .modal__overlay').on('click', () => {
    _jquery360MinJsDefault.default('.modal').fadeOut();
    _jquery360MinJsDefault.default('body').css('overflowY', 'scroll');
  });
  _jquery360MinJsDefault.default('.book-btn').on('click', () => {
    _jquery360MinJsDefault.default('.modal').fadeIn();
    _jquery360MinJsDefault.default('body').css('overflowY', 'hidden');
  });
});

},{"./header.js":"5WwWr","./slider.js":"2d7TM","./map.js":"hUPyO","./jquery-3.6.0.min.js":"6toMs","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5WwWr":[function(require,module,exports) {
'use strict';
...
},{}],"2d7TM":[function(require,module,exports) {
'use strict';
...
},{}],"hUPyO":[function(require,module,exports) {
'use strict';
